...
type ClusterAutoNodeBuilder struct {
	fieldSet_ []bool
	aws       *AwsAutoNodeConfigurationBuilder
	mode      AutoNodeMode
...
func (b *ClusterAutoNodeBuilder) AWS(value *AwsAutoNodeConfigurationBuilder) *ClusterAutoNodeBuilder {
...
//
// The configured mode of operation for AutoNode in the Cluster.
func (b *ClusterAutoNodeBuilder) Mode(value AutoNodeMode) *ClusterAutoNodeBuilder {
	if len(b.fieldSet_) == 0 {
		b.fieldSet_ = make([]bool, 3)
	}
	b.mode = value
...
func (b *ClusterAutoNodeBuilder) Copy(object *ClusterAutoNode) *ClusterAutoNodeBuilder {
	...
	if object.aws != nil {
		b.aws = NewAwsAutoNodeConfiguration().Copy(object.aws)
	} else {
		b.aws = nil
	}
	b.mode = object.mode
