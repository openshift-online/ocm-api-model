...
// ExternalAuthStatusKind is the name of the type used to represent objects
// of type 'external_auth_status'.
const ExternalAuthStatusKind = "ExternalAuthStatus"

// ExternalAuthStatusLinkKind is the name of the type used to represent links
// to objects of type 'external_auth_status'.
const ExternalAuthStatusLinkKind = "ExternalAuthStatusLink"

// ExternalAuthStatusNilKind is the name of the type used to nil references
// to objects of type 'external_auth_status'.
const ExternalAuthStatusNilKind = "ExternalAuthStatusNil"
...
func (o *ExternalAuthStatus) Kind() string {
	if o == nil {
		return ExternalAuthStatusNilKind
	}
	if o.bitmap_&1 != 0 {
		return ExternalAuthStatusLinkKind
	}
	return ExternalAuthStatusKind
}

// Link returns true if this is a link.
func (o *ExternalAuthStatus) Link() bool {
	return o != nil && o.bitmap_&1 != 0
}

// ID returns the identifier of the object.
func (o *ExternalAuthStatus) ID() string {
...
func (o *ExternalAuthStatus) GetID() (value string, ok bool) {
...
func (o *ExternalAuthStatus) HREF() string {
...
// link has a value.
func (o *ExternalAuthStatus) GetHREF() (value string, ok bool) {
...
// Kind returns the name of the type of the object.
func (l *ExternalAuthStatusList) Kind() string {
	if l == nil {
		return ExternalAuthStatusListNilKind
	}
	if l.link {
		return ExternalAuthStatusListLinkKind
	}
	return ExternalAuthStatusListKind
}

// Link returns true iif this is a link.
func (l *ExternalAuthStatusList) Link() bool {
	return l != nil && l.link
}

// HREF returns the link to the list.
func (l *ExternalAuthStatusList) HREF() string {
	if l != nil {
		return l.href
	}
	return ""
...
// link has a value.
func (l *ExternalAuthStatusList) GetHREF() (value string, ok bool) {
	ok = l != nil && l.href != ""
	if ok {
		value = l.href
	}
