...
type AzureBuilder struct {
	...
	imageRegistryCredentials        *AzureImageRegistryCredentialsBuilder
...
// ImageRegistryCredentials sets the value of the 'image_registry_credentials' attribute to the given value.
//
...
func (b *AzureBuilder) ImageRegistryCredentials(value *AzureImageRegistryCredentialsBuilder) *AzureBuilder {
	if len(b.fieldSet_) == 0 {
		b.fieldSet_ = make([]bool, 13)
	}
...
func (b *AzureBuilder) Copy(object *Azure) *AzureBuilder {
	...
	if object.imageRegistryCredentials != nil {
		b.imageRegistryCredentials = NewAzureImageRegistryCredentials().Copy(object.imageRegistryCredentials)
	} else {
		b.imageRegistryCredentials = nil
	}
	...
	b.oidcIssuerUrl = object.oidcIssuerUrl
	...
	b.vnetIntegrationSubnetResourceID = object.vnetIntegrationSubnetResourceID
	return b
}
...
func (b *AzureBuilder) Build() (object *Azure, err error) {
	...
	if b.imageRegistryCredentials != nil {
		object.imageRegistryCredentials, err = b.imageRegistryCredentials.Build()
		if err != nil {
			return
		}
	}
	...
	object.oidcIssuerUrl = b.oidcIssuerUrl
	...
	object.vnetIntegrationSubnetResourceID = b.vnetIntegrationSubnetResourceID
	return
}
