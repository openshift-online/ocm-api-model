...
func (l *OrganizationLinkList) SetLink(link bool) {
	l.link = link
}

// Items sets the items of the list.
func (l *OrganizationLinkList) SetHREF(href string) {
	l.href = href
}

// Items sets the items of the list.
func (l *OrganizationLinkList) SetItems(items []*OrganizationLink) {
	l.items = items
}

// Items returns the items of the list.
func (l *OrganizationLinkList) Items() []*OrganizationLink {
	if l == nil {
		return nil
	}
	return l.items
