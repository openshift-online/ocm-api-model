...
func (l *ClusterLinkList) SetLink(link bool) {
	l.link = link
}

// Items sets the items of the list.
func (l *ClusterLinkList) SetHREF(href string) {
	l.href = href
}

// Items sets the items of the list.
func (l *ClusterLinkList) SetItems(items []*ClusterLink) {
	l.items = items
}

// Items returns the items of the list.
func (l *ClusterLinkList) Items() []*ClusterLink {
	if l == nil {
		return nil
	}
	return l.items
