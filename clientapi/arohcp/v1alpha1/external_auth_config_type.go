...
//
// For ARO HCP clusters, please use the "State" property to enable/disable this feature instead.
...
// the zero value of the type if the attribute doesn't have a value.
//
// Controls whether the cluster uses an external authentication configuration.
//
// Possible values are "enabled" or "disabled".
//
// For ARO HCP clusters, this is always "enabled" by default and cannot be set to "disabled".
//
// FOR ROSA HCP clusters, please use the "Enabled" boolean flag to enable/disable this feature instead.
func (o *ExternalAuthConfig) State() string {
...
//
// FOR ROSA HCP clusters, please use the "Enabled" boolean flag to enable/disable this feature instead.
func (o *ExternalAuthConfig) GetState() (value string, ok bool) {
