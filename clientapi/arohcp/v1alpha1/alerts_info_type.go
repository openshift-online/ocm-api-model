...
// AlertsInfoListKind is the name of the type used to represent list of objects of
// type 'alerts_info'.
const AlertsInfoListKind = "AlertsInfoList"

// AlertsInfoListLinkKind is the name of the type used to represent links to list
// of objects of type 'alerts_info'.
const AlertsInfoListLinkKind = "AlertsInfoListLink"

// AlertsInfoNilKind is the name of the type used to nil lists of objects of
// type 'alerts_info'.
...
func (l *AlertsInfoList) Slice() []*AlertsInfo {
	var slice []*AlertsInfo
	if l == nil {
		slice = make([]*AlertsInfo, 0)
	} else {
		slice = make([]*AlertsInfo, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
