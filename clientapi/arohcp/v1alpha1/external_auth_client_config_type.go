...
// This is required to be defined for an external authentication provider belonging to an ARO HCP cluster.
//
// For clients belonging to a ROSA HCP cluster, the value of this property will be determined by the
