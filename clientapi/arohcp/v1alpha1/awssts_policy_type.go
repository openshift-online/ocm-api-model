...
// AWSSTSPolicyListKind is the name of the type used to represent list of objects of
// type 'AWSSTS_policy'.
const AWSSTSPolicyListKind = "AWSSTSPolicyList"

// AWSSTSPolicyListLinkKind is the name of the type used to represent links to list
// of objects of type 'AWSSTS_policy'.
const AWSSTSPolicyListLinkKind = "AWSSTSPolicyListLink"

// AWSSTSPolicyNilKind is the name of the type used to nil lists of objects of
// type 'AWSSTS_policy'.
...
func (l *AWSSTSPolicyList) Slice() []*AWSSTSPolicy {
	var slice []*AWSSTSPolicy
	if l == nil {
		slice = make([]*AWSSTSPolicy, 0)
	} else {
		slice = make([]*AWSSTSPolicy, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
