...
// ExternalConfigurationListKind is the name of the type used to represent list of objects of
// type 'external_configuration'.
const ExternalConfigurationListKind = "ExternalConfigurationList"

// ExternalConfigurationListLinkKind is the name of the type used to represent links to list
// of objects of type 'external_configuration'.
const ExternalConfigurationListLinkKind = "ExternalConfigurationListLink"

// ExternalConfigurationNilKind is the name of the type used to nil lists of objects of
// type 'external_configuration'.
...
func (l *ExternalConfigurationList) Slice() []*ExternalConfiguration {
	var slice []*ExternalConfiguration
	if l == nil {
		slice = make([]*ExternalConfiguration, 0)
	} else {
		slice = make([]*ExternalConfiguration, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
