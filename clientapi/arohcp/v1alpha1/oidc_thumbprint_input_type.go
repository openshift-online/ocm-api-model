...
func (l *OidcThumbprintInputList) SetLink(link bool) {
	l.link = link
}

// Items sets the items of the list.
func (l *OidcThumbprintInputList) SetHREF(href string) {
	l.href = href
}

// Items sets the items of the list.
func (l *OidcThumbprintInputList) SetItems(items []*OidcThumbprintInput) {
	l.items = items
}

// Items returns the items of the list.
func (l *OidcThumbprintInputList) Items() []*OidcThumbprintInput {
	if l == nil {
		return nil
	}
	return l.items
