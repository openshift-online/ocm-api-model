...
func (l *GitlabIdentityProviderList) SetLink(link bool) {
	l.link = link
}

// Items sets the items of the list.
func (l *GitlabIdentityProviderList) SetHREF(href string) {
	l.href = href
}

// Items sets the items of the list.
func (l *GitlabIdentityProviderList) SetItems(items []*GitlabIdentityProvider) {
	l.items = items
}

// Items returns the items of the list.
func (l *GitlabIdentityProviderList) Items() []*GitlabIdentityProvider {
	if l == nil {
		return nil
	}
	return l.items
