...
func (l *ProductMinimalVersionList) SetLink(link bool) {
	l.link = link
}

// Items sets the items of the list.
func (l *ProductMinimalVersionList) SetHREF(href string) {
	l.href = href
}

// Items sets the items of the list.
func (l *ProductMinimalVersionList) SetItems(items []*ProductMinimalVersion) {
	l.items = items
}

// Items returns the items of the list.
func (l *ProductMinimalVersionList) Items() []*ProductMinimalVersion {
	if l == nil {
		return nil
	}
	return l.items
