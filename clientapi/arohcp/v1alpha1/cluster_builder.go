...
// NodeSSHPublicKeys sets the value of the 'node_SSH_public_keys' attribute to the given values.
func (b *ClusterBuilder) NodeSSHPublicKeys(values ...string) *ClusterBuilder {
	if len(b.fieldSet_) == 0 {
		b.fieldSet_ = make([]bool, 64)
	}
	b.nodeSSHPublicKeys = make([]string, len(values))
	copy(b.nodeSSHPublicKeys, values)
	b.fieldSet_[48] = true
	return b
}
...
func (b *ClusterBuilder) Copy(object *Cluster) *ClusterBuilder {
	...
	if object.nodeSSHPublicKeys != nil {
		b.nodeSSHPublicKeys = make([]string, len(object.nodeSSHPublicKeys))
		copy(b.nodeSSHPublicKeys, object.nodeSSHPublicKeys)
	} else {
		b.nodeSSHPublicKeys = nil
	}
...
func (b *ClusterBuilder) Build() (object *Cluster, err error) {
	...
	if b.nodeSSHPublicKeys != nil {
		object.nodeSSHPublicKeys = make([]string, len(b.nodeSSHPublicKeys))
		copy(object.nodeSSHPublicKeys, b.nodeSSHPublicKeys)
	}
