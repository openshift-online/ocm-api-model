...
func (l *TrustedIpList) SetLink(link bool) {
	l.link = link
}

// Items sets the items of the list.
func (l *TrustedIpList) SetHREF(href string) {
	l.href = href
}

// Items sets the items of the list.
func (l *TrustedIpList) SetItems(items []*TrustedIp) {
	l.items = items
}

// Items returns the items of the list.
func (l *TrustedIpList) Items() []*TrustedIp {
	if l == nil {
		return nil
	}
	return l.items
