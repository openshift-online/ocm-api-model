...
func writePrivateLinkPrincipalsAddRequest(request *PrivateLinkPrincipalsAddRequest, writer io.Writer) error {
	return MarshalPrivateLinkPrincipal(request.body, writer)
}
func readPrivateLinkPrincipalsAddResponse(response *PrivateLinkPrincipalsAddResponse, reader io.Reader) error {
	var err error
