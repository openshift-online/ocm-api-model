...
// the zero value of the type if the attribute doesn't have a value.
//
// Name is the unique identifier for the image mirror within the cluster.
// Name must be unique per cluster and is immutable after creation.
// Name must match naming conventions (alphanumeric, hyphens, max 63 chars).
func (o *ImageMirror) Name() string {
...
// Name must be unique per cluster and is immutable after creation.
// Name must match naming conventions (alphanumeric, hyphens, max 63 chars).
func (o *ImageMirror) GetName() (value string, ok bool) {
