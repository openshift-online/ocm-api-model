...
func writeKubeletConfigsAddRequest(request *KubeletConfigsAddRequest, writer io.Writer) error {
	return MarshalKubeletConfig(request.body, writer)
}
func readKubeletConfigsAddResponse(response *KubeletConfigsAddResponse, reader io.Reader) error {
	var err error
