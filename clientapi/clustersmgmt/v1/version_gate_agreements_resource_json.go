...
func readVersionGateAgreementsAddResponse(response *VersionGateAgreementsAddResponse, reader io.Reader) error {
	var err error
...
func readVersionGateAgreementsListResponse(response *VersionGateAgreementsListResponse, reader io.Reader) error {
