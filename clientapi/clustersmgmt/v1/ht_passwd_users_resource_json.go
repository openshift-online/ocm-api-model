...
func writeHTPasswdUsersAddRequest(request *HTPasswdUsersAddRequest, writer io.Writer) error {
	return MarshalHTPasswdUser(request.body, writer)
}
func readHTPasswdUsersAddResponse(response *HTPasswdUsersAddResponse, reader io.Reader) error {
	var err error
