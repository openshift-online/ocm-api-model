...
func writeExternalAuthsAddRequest(request *ExternalAuthsAddRequest, writer io.Writer) error {
	return MarshalExternalAuth(request.body, writer)
}
func readExternalAuthsAddResponse(response *ExternalAuthsAddResponse, reader io.Reader) error {
	var err error
