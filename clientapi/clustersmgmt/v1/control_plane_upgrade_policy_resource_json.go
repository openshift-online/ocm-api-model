...
func writeControlPlaneUpgradePolicyUpdateRequest(request *ControlPlaneUpgradePolicyUpdateRequest, writer io.Writer) error {
	return MarshalControlPlaneUpgradePolicy(request.body, writer)
}
func readControlPlaneUpgradePolicyUpdateResponse(response *ControlPlaneUpgradePolicyUpdateResponse, reader io.Reader) error {
	var err error
	response.body, err = UnmarshalControlPlaneUpgradePolicy(reader)
	return err
}
