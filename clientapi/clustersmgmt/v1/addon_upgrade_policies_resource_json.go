...
func writeAddonUpgradePoliciesAddRequest(request *AddonUpgradePoliciesAddRequest, writer io.Writer) error {
	return MarshalAddonUpgradePolicy(request.body, writer)
}
func readAddonUpgradePoliciesAddResponse(response *AddonUpgradePoliciesAddResponse, reader io.Reader) error {
	var err error
