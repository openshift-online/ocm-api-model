...
func writeBreakGlassCredentialsAddRequest(request *BreakGlassCredentialsAddRequest, writer io.Writer) error {
	return MarshalBreakGlassCredential(request.body, writer)
}
func readBreakGlassCredentialsAddResponse(response *BreakGlassCredentialsAddResponse, reader io.Reader) error {
	var err error
