...
func writeHcpKubeletConfigUpdateRequest(request *HcpKubeletConfigUpdateRequest, writer io.Writer) error {
	return MarshalKubeletConfig(request.body, writer)
}
func readHcpKubeletConfigUpdateResponse(response *HcpKubeletConfigUpdateResponse, reader io.Reader) error {
	var err error
	response.body, err = UnmarshalKubeletConfig(reader)
	return err
}
