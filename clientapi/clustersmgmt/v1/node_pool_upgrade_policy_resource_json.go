...
func writeNodePoolUpgradePolicyUpdateRequest(request *NodePoolUpgradePolicyUpdateRequest, writer io.Writer) error {
	return MarshalNodePoolUpgradePolicy(request.body, writer)
}
func readNodePoolUpgradePolicyUpdateResponse(response *NodePoolUpgradePolicyUpdateResponse, reader io.Reader) error {
	var err error
	response.body, err = UnmarshalNodePoolUpgradePolicy(reader)
	return err
}
