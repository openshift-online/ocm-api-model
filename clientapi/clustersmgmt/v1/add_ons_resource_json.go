...
func readAddOnsAddResponse(response *AddOnsAddResponse, reader io.Reader) error {
	var err error
...
func readAddOnsListResponse(response *AddOnsListResponse, reader io.Reader) error {
