...
func writeControlPlaneUpgradePoliciesAddRequest(request *ControlPlaneUpgradePoliciesAddRequest, writer io.Writer) error {
	return MarshalControlPlaneUpgradePolicy(request.body, writer)
}
func readControlPlaneUpgradePoliciesAddResponse(response *ControlPlaneUpgradePoliciesAddResponse, reader io.Reader) error {
	var err error
