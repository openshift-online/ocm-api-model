...
func writeRegistryAllowlistsAddRequest(request *RegistryAllowlistsAddRequest, writer io.Writer) error {
	return MarshalRegistryAllowlist(request.body, writer)
}
func readRegistryAllowlistsAddResponse(response *RegistryAllowlistsAddResponse, reader io.Reader) error {
	var err error
