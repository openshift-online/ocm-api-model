...
func writeSyncsetsAddRequest(request *SyncsetsAddRequest, writer io.Writer) error {
	return MarshalSyncset(request.body, writer)
}
func readSyncsetsAddResponse(response *SyncsetsAddResponse, reader io.Reader) error {
	var err error
