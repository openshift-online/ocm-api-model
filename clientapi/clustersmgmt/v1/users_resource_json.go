...
func writeUsersAddRequest(request *UsersAddRequest, writer io.Writer) error {
	return MarshalUser(request.body, writer)
}
func readUsersAddResponse(response *UsersAddResponse, reader io.Reader) error {
	var err error
