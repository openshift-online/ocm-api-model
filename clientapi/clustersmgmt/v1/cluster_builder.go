...
// ControlPlane sets the value of the 'control_plane' attribute to the given value.
//
...
// Maintenance sets the value of the 'maintenance' attribute to the given value.
//
// Maintenance configuration.
func (b *ClusterBuilder) Maintenance(value *MaintenanceBuilder) *ClusterBuilder {
	if len(b.fieldSet_) == 0 {
		b.fieldSet_ = make([]bool, 67)
	}
	b.maintenance = value
...
func (b *ClusterBuilder) Copy(object *Cluster) *ClusterBuilder {
	...
	if object.controlPlane != nil {
		b.controlPlane = NewControlPlane().Copy(object.controlPlane)
	} else {
		b.controlPlane = nil
	}
	...
	if object.maintenance != nil {
		b.maintenance = NewMaintenance().Copy(object.maintenance)
	} else {
		b.maintenance = nil
	}
...
func (b *ClusterBuilder) Build() (object *Cluster, err error) {
	...
	if b.controlPlane != nil {
		object.controlPlane, err = b.controlPlane.Build()
		if err != nil {
			return
		}
	}
	...
	if b.maintenance != nil {
		object.maintenance, err = b.maintenance.Build()
		if err != nil {
			return
		}
	}
