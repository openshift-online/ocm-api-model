...
func writeManifestsAddRequest(request *ManifestsAddRequest, writer io.Writer) error {
	return MarshalManifest(request.body, writer)
}
func readManifestsAddResponse(response *ManifestsAddResponse, reader io.Reader) error {
	var err error
