...
func writeLabelPostRequest(request *LabelPostRequest, writer io.Writer) error {
	return MarshalLabelRequestPayload(request.request, writer)
}
func readLabelPostResponse(response *LabelPostResponse, reader io.Reader) error {
	var err error
	response.response, err = UnmarshalLabel(reader)
	return err
}
