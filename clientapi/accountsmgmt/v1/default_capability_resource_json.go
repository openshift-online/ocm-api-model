...
func writeDefaultCapabilityUpdateRequest(request *DefaultCapabilityUpdateRequest, writer io.Writer) error {
	return MarshalDefaultCapability(request.body, writer)
}
func readDefaultCapabilityUpdateResponse(response *DefaultCapabilityUpdateResponse, reader io.Reader) error {
	var err error
	response.body, err = UnmarshalDefaultCapability(reader)
	return err
}
