...
func writeDefaultCapabilitiesAddRequest(request *DefaultCapabilitiesAddRequest, writer io.Writer) error {
	return MarshalDefaultCapability(request.body, writer)
}
func readDefaultCapabilitiesAddResponse(response *DefaultCapabilitiesAddResponse, reader io.Reader) error {
	var err error
