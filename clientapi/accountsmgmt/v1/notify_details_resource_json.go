...
func writeNotifyDetailsPostRequest(request *NotifyDetailsPostRequest, writer io.Writer) error {
	return MarshalNotificationDetailsRequest(request.request, writer)
}
