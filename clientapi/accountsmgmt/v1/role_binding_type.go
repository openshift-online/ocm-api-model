...
type RoleBinding struct {
	...
	createdAt      time.Time
	managedBy      RoleBindingManagedBy
...
// the zero value of the type if the attribute doesn't have a value.
func (o *RoleBinding) ManagedBy() RoleBindingManagedBy {
	if o != nil && len(o.fieldSet_) > 9 && o.fieldSet_[9] {
		return o.managedBy
	}
	return RoleBindingManagedBy("")
}

// GetManagedBy returns the value of the 'managed_by' attribute and
// a flag indicating if the attribute has a value.
func (o *RoleBinding) GetManagedBy() (value RoleBindingManagedBy, ok bool) {
