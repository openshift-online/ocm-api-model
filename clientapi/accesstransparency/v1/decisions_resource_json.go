...
func writeDecisionsAddRequest(request *DecisionsAddRequest, writer io.Writer) error {
	return MarshalDecision(request.body, writer)
}
func readDecisionsAddResponse(response *DecisionsAddResponse, reader io.Reader) error {
	var err error
