...
func readProductGetResponse(response *ProductGetResponse, reader io.Reader) error {
	var err error
...
func readProductUpdateResponse(response *ProductUpdateResponse, reader io.Reader) error {
	var err error
	response.body, err = UnmarshalProduct(reader)
	return err
}
