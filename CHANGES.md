...
- Add `AddonClusters` locator in root resource model.
- Add `Addon` locator in `AddonStatuses` resource model
- Updated `AddOnStatusType` for `StatusConditions` and `AddonId`
